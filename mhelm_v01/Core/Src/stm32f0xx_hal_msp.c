...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    */
    ...
    /* ADC1 interrupt Init */
    HAL_NVIC_SetPriority(ADC1_IRQn, INT_PRIO_ADC, 0);
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspInit 0 */
    ...
    I2C for the DACs to control throttle and regen
    PB6     ------> I2C1_SCL
    PB7     ------> I2C1_SDA
    */
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    /* TIM1 interrupt Init */
    HAL_NVIC_SetPriority(TIM1_BRK_UP_TRG_COM_IRQn, INT_PRIO_RT_TASK, 0);
    HAL_NVIC_EnableIRQ(TIM1_BRK_UP_TRG_COM_IRQn);
    HAL_NVIC_SetPriority(TIM1_CC_IRQn, INT_PRIO_RT_TASK, 0);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    PC8     ------> TIM3_CH3
    */
    GPIO_InitStruct.Pin = LCD1_BL_RED_Pin|LCD1_BL_GREEN_Pin;
    ...
    GPIO_InitStruct.Pin = LCD1_BL_BLUE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM3;
    HAL_GPIO_Init(LCD1_BL_BLUE_GPIO_Port, &GPIO_InitStruct);
