...
#define I2C_ACTIVATE_DAC(PORT,PIN)  HAL_GPIO_WritePin(PORT, PIN, MCP4725_SET_ADDRESS_ACTIVE)
#define I2C_DEACTIVATE_DAC(PORT,PIN) HAL_GPIO_WritePin(PORT, PIN, MCP4725_SET_ADDRESS_COMMON)
